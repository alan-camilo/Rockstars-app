...
class RockstarsAdapter(private val myDataset: ArrayList<Rockstar>) :
    ...
    class MyViewHolder(val linearLayout: LinearLayout) : RecyclerView.ViewHolder(linearLayout) {
        var tv_name: TextView = linearLayout.findViewById(R.id.rockstar_name)
        var tv_status: TextView = linearLayout.findViewById(R.id.rockstar_status)
        var iv_picture: ImageView = linearLayout.findViewById(R.id.rockstar_img)
    }
